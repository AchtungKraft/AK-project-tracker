...
export default function ProjectOverview({ project, projectId }) {
  ...
  return (
    <div className="space-y-6">
      {/* Compact Project Header with Key Details */}
      <Card className="bg-black/40 backdrop-blur-xl border border-red-900/30">
        <CardContent className="p-6">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h2 className="text-2xl font-bold text-white mb-1">{project?.name}</h2>
              <p className="text-gray-400">{project?.client_name || 'No client assigned'}</p>
            </div>
            <Button
              variant="outline"
              size="sm"
          ...
          {editing ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div>
                <Label className="text-xs text-gray-400">Client Email</Label>
                <Input
              ...
              <div>
                <Label className="text-xs text-gray-400">VIN / Chassis</Label>
                <Input
                  value={formData.vin}
              ...
              <div>
                <Label className="text-xs text-gray-400">Target Completion</Label>
                <Input
                  type="date"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white text-xs font-medium">{project?.progress_percent || 0}%</span>
                </div>
              </div>
              <div>
                <p className="text-xs text-gray-400 mb-1">Client Email</p>
                <p className="text-white text-xs truncate">{project?.client_email || '-'}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-white">{project?.start_date ? format(new Date(project.start_date), 'MMM d, yyyy') : '-'}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400 mb-1">Target</p>
                <p className="text-white">{project?.target_completion ? format(new Date(project.target_completion), 'MMM d, yyyy') : '-'}</p>
              </div>
            </div>
          )}
        </CardContent>
