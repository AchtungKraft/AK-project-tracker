    ...
    if (order_id) {
      ...
      const lines = lineItems.map(li => {
        ...
        return {
          ...
          effective_unit_cost: li.effective_unit_cost || li.unit_cost || li.unit_price || 0,
          allocated_freight: li.allocated_freight || 0,
          allocated_tariff: li.allocated_tariff || 0,
          allocated_tax: li.allocated_tax || 0,
          allocated_misc: li.allocated_misc || 0,
